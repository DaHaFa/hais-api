...
public class Room implements Serializable, Identifiable<Long> {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "RoomGenerator")
	@SequenceGenerator(name = "RoomGenerator", sequenceName = "RoomSequence", allocationSize = 1)
	private long roomID;
